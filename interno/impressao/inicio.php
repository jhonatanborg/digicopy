            ...
            <div class="table-title">
                ...
                <div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Novo Serviço</span></a>
...
<a href="#" class="edit"><i type="button" class="material-icons orange600" data-toggle="modal" title="Edit" data-target="#exampleModal"
	...
	<div id="addEmployeeModal" class="modal fade">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<input type="text" class="form-control" required name="codigo" id="codigo" onkeyup="somenteNumeros(this);">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" required name="quantidade" onkeyup="somenteNumeros(this);">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" required name="valor_unidade" onkeyup="somenteNumeros(this);">
			...
			<div class="modal-content">
				...
				<form method="POST" action="delete.php">
					...
					<div class="modal-body">
						...
						<small>Fazendo isso você deleterá o serviço permanentemente</small></p>
