...
<div class="rounded-btn">
    ...
    <a href="relatorio_recusados.php"><button class="btn btn-lg btn-success" target="_blank" ><i class="material-icons">&#xE147;</i>Extrair Relatório</button></a>
...
WHERE impressao.status=2 AND NOT produtos.status=1"
