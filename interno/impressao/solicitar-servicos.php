        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="solicitar-servicos.php">SOLICITAR SERVIÇO</a></li>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="edit"><i type="button" class="material-icons orange600" data-toggle="modal"
                                title="Adicionar" data-target="#Adicionar"
                ...
                <form method="POST" action="send_impres.php">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" placeholder="Número de páginas"
                                name="quantidade" onkeyup="somenteNumeros(this);">
                        </div>

                        <div class="form-group">
                            <label>Dercrição</label>
                            <input required type="text" class="form-control" placeholder="Descreva a impressão"
                                name="descricao">
                        </div>
