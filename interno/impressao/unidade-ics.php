				...
				<div class="col-sm-6">
					...
					<div class="row ">
						...
						<div class="rounded-btn">
							...
							<a href="#"><button class="btn btn-lg btn-success">Pró Reitoria</button></a>
							<a href="#"> <button class="btn btn-lg btn-info">SAE</button></a>
							<a href="#"><button class="btn btn-lg btn-warning">GGE</button></a>
							<a href="#"><button class="btn btn-lg btn-danger">CODEX</button></a>
							<a href="#"><button class="btn btn-lg btn-danger">ICNHS</button></a>
							<a href="#"><button class="btn btn-lg btn-secundary">ICAA</button></a>
							<a href="#"><button class="btn btn-lg btn-primary">ICS</button></a>
...
case when impressao.unidade = 1 then 'Pró - Reitoria'
when impressao.unidade = 2 then 'SAE'
when impressao.unidade = 3 then 'GGE'
when impressao.unidade = 4 then 'CODEX'
when impressao.unidade = 5 then 'ICNHS'
when impressao.unidade = 6 then 'ICAA'
when impressao.unidade = 7 then 'ICS'
end as unidade
