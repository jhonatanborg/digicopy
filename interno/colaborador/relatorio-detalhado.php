...
<div class="container-fluid">
  ...
  <div id="navbar" class="navbar-collapse collapse">
    ...
    <div class="container">
        <h1>Pesquisar</h1>
        <form method="POST" action="resultado-novo-relatorio.php">
            <div class="form-group form-group-multiple-selectsp col-xs-11 col-sm-8 col-md-5 mt-6">
            ...
            <div class="form-group form-group-multiple-selectsp col-xs-11 col-sm-8 col-md-4 mt-6">
                <div class="input-group input-group-multiple-selectp col-xs-8">
