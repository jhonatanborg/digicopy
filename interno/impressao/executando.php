...
<div class="rounded-btn">
    ...
    <a href="relatorio_executando.php"><button class="btn btn-lg btn-success" target="_blank" ><i class="material-icons">&#xE147;</i>Extrair Relatório</button></a>

    <a href="solicitados.php"><button class="btn btn-lg " style="background-color: #48a0f2;">Todos</button></a>
    ...
    <a href="executando.php"><button class="btn btn-lg btn-warning">Executando</button></a>
...
when impressao.status=5 then 'EXCLUÍDO' end as Status,
...
WHERE impressao.status=3 AND NOT produtos.status=1"
...
<a href="#" class="edit"><i type="button" class="material-icons" data-toggle="modal" title="Edit" data-target="#exampleModal"
...
<a href="#" class="send"><i class="material-icons" type="button" class="material-icons" data-toggle="modal" title="confirmar"
...
data-whateverdisponivel="<?php echo $rows_impres['disponivel']; ?>"
      ...
      <div class="modal-content">
        ...
        <form method="POST" action="confirmar.php">
          ...
          <div class="modal-body">
            ...
            <small>Ao confirmar essa solitação, o serviço será encaminhado direto para a Digicopy</small></p>
